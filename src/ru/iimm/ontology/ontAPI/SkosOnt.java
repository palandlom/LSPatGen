...
public class SkosOnt extends Ontology implements ConstantsOntAPI
{
	 ...
	 * онтология будет загружаться из нескольких файлов.
	 * @param skosfile основной файл
	 * @param mergeImportedOntology
	 * @param makeConsitnenseCheck
	 */
	public SkosOnt(File skosfile, Boolean mergeImportedOntology,  Boolean makeConsitnenseCheck)
	 {			
		 super(skosfile, mergeImportedOntology, makeConsitnenseCheck);
		 this.broaderConceptMap = new HashMap<OWLNamedIndividual, HashSet<OWLNamedIndividual>>();
		 this.narrowerConceptMap = new HashMap<OWLNamedIndividual, HashSet<OWLNamedIndividual>>();
