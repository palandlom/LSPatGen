...
public class TimeIntervalCDP extends ContentDesingPattern
{
	...
	/* Class names */
	static String TIME_INTEVAL_IRI = "TimeInterval";

	/* Properties names */
	static String HAS_INTERVAL_DATA_IRI =  "hasIntervalData";
	static String HAS_INTERVAL_END_DATA_IRI =  "hasIntervalEndData";
	static String HAS_INTERVAL_START_DATA_IRI =  "hasIntervalStartData";
	...
	void init()
	{
		this.intervalDate = df.getOWLClass(IRI.create(this.getBaseIRI()+TIME_INTEVAL_IRI));

		this.hasIntervalData = df.getOWLDataProperty(IRI.create(this.getBaseIRI()+HAS_INTERVAL_DATA_IRI));
		this.hasIntervalEndData = df
		        .getOWLDataProperty(IRI.create(this.getBaseIRI()+HAS_INTERVAL_END_DATA_IRI));
		this.hasIntervalStartData = df
		        .getOWLDataProperty(IRI.create(this.getBaseIRI()+HAS_INTERVAL_START_DATA_IRI));
	}
